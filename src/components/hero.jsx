...
const Hero = () => (
  <>
    ...
    <section className="container relative mx-auto text-white sm:px-0">
      <div className="relative w-10/12 px-4 pt-16 sm:pt-28 md:pt-28">
        ...
        <div className="flex flex-col sm:flex-row">
          <button type="button" className="w-32 mb-3 btn btn-yellow sm:m-0">Oferta</button>
          <button type="button" className="w-32 sm:ml-4 btn">Kontakt</button>
        </div>
      </div>
      <div className="relative flex justify-around w-full -top-20">
